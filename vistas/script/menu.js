...
function init(){
    ...
    $.post("../ajax/menu.php?op=permisos&id=0",function(r){
        $("#permisos").html(r);
...
function activar(idcategoria){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("../ajax/menu.php?op=activar", {idcategoria : idcategoria}, function(e){
    //            alert(e);
    Swal.fire(
        'Anular',
        e,
...
function desactivar(idcategoria){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("../ajax/menu.php?op=desactivar", {idcategoria : idcategoria}, function(e){
                alert(e);
                tabla.ajax.reload();
            });	
          Swal.fire(
...
function mostrar(idcategoria){
    ...
    $.post("../ajax/menu.php?op=mostrar",{idcategoria : idcategoria}, function(data, status)
    {
